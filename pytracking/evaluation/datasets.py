...
dataset_dict = dict(
    ...
    fish_mw=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="MW")),
    fish_sb=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="SB")),
    fish_cr=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="CR")),
    fish_sg=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="SG")),
    fish_is=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="IS")),
    fish_al=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="AL")),
    fish_pl=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="PL")),
    fish_lr=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="LR")),
    fish_arc=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="ARC")),
    fish_sv=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="SV")),
    fish_po=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="PO")),
    fish_db=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="DB")),
    fish_co=DatasetInfo(module=pt % "fish", class_name="FishDataset", kwargs=dict(split="CO")),
