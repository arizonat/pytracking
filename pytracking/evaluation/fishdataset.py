...
class FishDataset(BaseDataset):
    ...
    def _get_sequence_list(self):
        sequence_list= ['girdhar_parrotfish_30fps_480p_usvi_GOPR1481',
                        ...
                        'GX010057.MP4_clip',
                        'GX010082_snapper.MP4_clip',
                        'GX010089_shark.MP4_clip',
                        'GX010090_shark.MP4_clip',
                        'GX010091_shark.MP4_clip',
                        'GX010125_stingray.MP4_clip',
                        'GX010130_2jacks.MP4_clip',
                        'GX010155_barracuda_dendrogyra.MP4_clip',
                        'GX010225_turtle_eating_jelly.MP4_clip',
                        'GX010250_jellyfish.MP4_clip']

        # sequence_list = ['GX010057.MP4_clip',
        #                 'GX010082_snapper.MP4_clip',
        #                 'GX010089_shark.MP4_clip',
        #                 'GX010090_shark.MP4_clip',
        #                 'GX010091_shark.MP4_clip',
